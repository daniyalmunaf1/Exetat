							...
							<div class="d-flex flex-column flex-lg-row">
								...
								<div class="flex-column flex-lg-row-auto w-100 w-lg-275px mb-10 mb-lg-0">
									...
									<div class="card card-flush mb-0" data-kt-sticky="false" data-kt-sticky-name="inbox-aside-sticky" data-kt-sticky-offset="{default: false, xl: '0px'}" data-kt-sticky-width="{lg: '275px'}" data-kt-sticky-left="auto" data-kt-sticky-top="150px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
										...
										<div class="card-body">
											<!--begin::Button-->
											<a href="{{route('new-publication')}}" class="btn btn-primary text-uppercase w-100 mb-10">New Publication</a>
											<!--end::Button-->
											<!--begin::Menu-->
											<div class="menu menu-column menu-rounded menu-state-bg menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary mb-10">
                                                ...
                                                <a href="{{route('view-publication',$publication->id)}}">
												<div class="menu-item mb-3">
													...
													<span class="menu-link">
														...
														<span class="menu-title fw-bold">{{$publication->title}}</span>
													</span>
													<!--end::Draft-->
												</div>
                                                @endforeach
												...
												<div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer" data-kt-inbox-message="header">
													...
													<div class="d-flex align-items-center">
														...
														<div class="pe-5">
															...
															<div class="d-flex align-items-center flex-wrap gap-1">
																<h1 href="#" class="fw-bold text-dark text-hover-primary">{{$first->title}}</h1>
													...
													<div class="d-flex align-items-center flex-wrap gap-2">
														...
														<div class="d-flex">
															@can('admin-helpdesk')
															<!--begin::Reply-->
															<a href="{{route('edit-publication',$first->id)}}" class="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
															...
															<!--begin::Settings-->
															@can('admin')
															<a href="{{route('delete-publication',$first->id)}}" class="btn btn-sm btn-icon btn-clear btn-active-light-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Settings">
