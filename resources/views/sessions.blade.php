							...
							<div class="d-flex flex-column flex-lg-row">
								...
								<div class="flex-column flex-lg-row-auto w-100 w-lg-275px mb-10 mb-lg-0">
									...
									<div class="card card-flush mb-0" data-kt-sticky="false" data-kt-sticky-name="inbox-aside-sticky" data-kt-sticky-offset="{default: false, xl: '0px'}" data-kt-sticky-width="{lg: '275px'}" data-kt-sticky-left="auto" data-kt-sticky-top="150px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
										<!--begin::Aside content-->
										<div class="card-body">
										<h1 style="text-align:center;margin-bottom:10px;">Sessions</h1>

										@can('admin')
										<a href="{{route('new-session')}}" class="btn btn-primary text-uppercase w-100 mb-2">Add Session</a>
											@endcan
											<!--begin::Menu-->
											<div class="menu menu-column menu-rounded menu-state-bg menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary mb-10">
                                                ...
                                                <a href="{{route('view-sessions',$section->id)}}">
												<div class="menu-item mb-3">
													...
													<span class="menu-link">
														...
														<span class="menu-title fw-bold">{{$section->title}}</span>
													</span>
													<!--end::Draft-->
												</div>
                                                @endforeach
												...
												<div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer" data-kt-inbox-message="header">
													...
													<div class="d-flex align-items-center">
														...
														<div class="pe-5">
															...
															<div class="d-flex align-items-center flex-wrap gap-1">
																<h1 href="#" class="fw-bold text-dark text-hover-primary">Session : {{$first->title}}</h1>
													...
													<div class="d-flex align-items-center flex-wrap gap-2">
														...
														<div class="d-flex">
															@can('admin-helpdesk')
															<!--begin::Reply-->
															<a href="{{route('edit-session',$session->id)}}" class="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
															...
															<!--begin::Settings-->
															@can('admin')
															<a href="{{route('delete-session',$session->id)}}" class="btn btn-sm btn-icon btn-clear btn-active-light-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Settings">
												...
												<div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer" data-kt-inbox-message="header">
													...
													<div class="d-flex align-items-center">
														...
														<div class="pe-5">
															<!--begin::Author details-->
															<div class="d-flex align-items-center flex-wrap gap-1">
																<div class="row"><h3 href="#" class="fw-bold text-dark text-hover-primary">Exam 1</h3>
																<span href="#" class="fw-bold text-dark text-hover-primary">Duration : {{$session->duration}}</span>
																<span href="#" class="fw-bold text-dark text-hover-primary">{{$session->numberOfQuestions}} Questions</span></div>
																<!--begin::Svg Icon | path: icons/duotune/abstract/abs050.svg-->
																<span class="svg-icon svg-icon-7 svg-icon-success mx-3">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																	</svg>
													...
													<div class="d-flex align-items-center flex-wrap gap-2">
														...
														<div class="d-flex">
															...
															<!--begin::Reply-->
															@if($Exam1)
															<p style="Background-color:#009ef7;Color:white;padding:10px;" >Attempted</p>
															@else
															<a href="{{route('attempt',['exam'=>1,'id'=>$session->id])}}" class="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Attempt">
																<!--begin::Svg Icon | path: icons/duotune/general/gen055.svg-->
																<span class="svg-icon svg-icon-2 m-0">
																	<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
																		<path opacity="0.3" fill-rule="evenodd" clip-rule="evenodd" d="M2 4.63158C2 3.1782 3.1782 2 4.63158 2H13.47C14.0155 2 14.278 2.66919 13.8778 3.04006L12.4556 4.35821C11.9009 4.87228 11.1726 5.15789 10.4163 5.15789H7.1579C6.05333 5.15789 5.15789 6.05333 5.15789 7.1579V16.8421C5.15789 17.9467 6.05333 18.8421 7.1579 18.8421H16.8421C17.9467 18.8421 18.8421 17.9467 18.8421 16.8421V13.7518C18.8421 12.927 19.1817 12.1387 19.7809 11.572L20.9878 10.4308C21.3703 10.0691 22 10.3403 22 10.8668V19.3684C22 20.8218 20.8218 22 19.3684 22H4.63158C3.1782 22 2 20.8218 2 19.3684V4.63158Z" fill="currentColor" />
												...
												<div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer" data-kt-inbox-message="header">
													...
													<div class="d-flex align-items-center">
														...
														<div class="pe-5">
															<!--begin::Author details-->
															<div class="d-flex align-items-center flex-wrap gap-1">
																<div class="row"><h3 href="#" class="fw-bold text-dark text-hover-primary">Exam 2</h3>
																<span href="#" class="fw-bold text-dark text-hover-primary">Duration : {{$session->duration}}</span>
																<span href="#" class="fw-bold text-dark text-hover-primary">{{$session->numberOfQuestions}} Questions</span></div>																<!--begin::Svg Icon | path: icons/duotune/abstract/abs050.svg-->
																<span class="svg-icon svg-icon-7 svg-icon-success mx-3">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																	</svg>
																</span>
													...
													<div class="d-flex align-items-center flex-wrap gap-2">
														...
														<div class="d-flex">
															...
															<p style="Background-color:#009ef7;Color:white;padding:10px;" >Attempted</p>
															@else
															<a href="{{route('attempt',['exam'=>2,'id'=>$session->id])}}" class="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Attempt">
																<!--begin::Svg Icon | path: icons/duotune/general/gen055.svg-->
																<span class="svg-icon svg-icon-2 m-0">
																	<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
																		<path opacity="0.3" fill-rule="evenodd" clip-rule="evenodd" d="M2 4.63158C2 3.1782 3.1782 2 4.63158 2H13.47C14.0155 2 14.278 2.66919 13.8778 3.04006L12.4556 4.35821C11.9009 4.87228 11.1726 5.15789 10.4163 5.15789H7.1579C6.05333 5.15789 5.15789 6.05333 5.15789 7.1579V16.8421C5.15789 17.9467 6.05333 18.8421 7.1579 18.8421H16.8421C17.9467 18.8421 18.8421 17.9467 18.8421 16.8421V13.7518C18.8421 12.927 19.1817 12.1387 19.7809 11.572L20.9878 10.4308C21.3703 10.0691 22 10.3403 22 10.8668V19.3684C22 20.8218 20.8218 22 19.3684 22H4.63158C3.1782 22 2 20.8218 2 19.3684V4.63158Z" fill="currentColor" />
												...
												<div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer" data-kt-inbox-message="header">
													...
													<div class="d-flex align-items-center">
														...
														<div class="pe-5">
															<!--begin::Author details-->
															<div class="d-flex align-items-center flex-wrap gap-1">
																<div class="row"><h3 href="#" class="fw-bold text-dark text-hover-primary">Exam 3</h3>
																<span href="#" class="fw-bold text-dark text-hover-primary">Duration : {{$session->duration}}</span>
																<span href="#" class="fw-bold text-dark text-hover-primary">{{$session->numberOfQuestions}} Questions</span></div>																<!--begin::Svg Icon | path: icons/duotune/abstract/abs050.svg-->
																<span class="svg-icon svg-icon-7 svg-icon-success mx-3">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													...
													<div class="d-flex align-items-center flex-wrap gap-2">
														...
														<div class="d-flex">
															...
															<p style="Background-color:#009ef7;Color:white;padding:10px;" >Attempted</p>
															@else
															<a href="{{route('attempt',['exam'=>3,'id'=>$session->id])}}" class="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Attempt">
																<!--begin::Svg Icon | path: icons/duotune/general/gen055.svg-->
																<span class="svg-icon svg-icon-2 m-0">
																	<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
																		<path opacity="0.3" fill-rule="evenodd" clip-rule="evenodd" d="M2 4.63158C2 3.1782 3.1782 2 4.63158 2H13.47C14.0155 2 14.278 2.66919 13.8778 3.04006L12.4556 4.35821C11.9009 4.87228 11.1726 5.15789 10.4163 5.15789H7.1579C6.05333 5.15789 5.15789 6.05333 5.15789 7.1579V16.8421C5.15789 17.9467 6.05333 18.8421 7.1579 18.8421H16.8421C17.9467 18.8421 18.8421 17.9467 18.8421 16.8421V13.7518C18.8421 12.927 19.1817 12.1387 19.7809 11.572L20.9878 10.4308C21.3703 10.0691 22 10.3403 22 10.8668V19.3684C22 20.8218 20.8218 22 19.3684 22H4.63158C3.1782 22 2 20.8218 2 19.3684V4.63158Z" fill="currentColor" />
												...
												<div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer" data-kt-inbox-message="header">
													...
													<div class="d-flex align-items-center">
														...
														<div class="pe-5">
															<!--begin::Author details-->
															<div class="d-flex align-items-center flex-wrap gap-1">
																<div class="row"><h3 href="#" class="fw-bold text-dark text-hover-primary">Exam 4</h3>
																<span href="#" class="fw-bold text-dark text-hover-primary">Duration : {{$session->duration}}</span>
																<span href="#" class="fw-bold text-dark text-hover-primary">{{$session->numberOfQuestions}} Questions</span></div>																<!--begin::Svg Icon | path: icons/duotune/abstract/abs050.svg-->
																<span class="svg-icon svg-icon-7 svg-icon-success mx-3">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													...
													<div class="d-flex align-items-center flex-wrap gap-2">
														...
														<div class="d-flex">
															...
															<p style="Background-color:#009ef7;Color:white;padding:10px;" >Attempted</p>
															@else
															<a href="{{route('attempt',['exam'=>4,'id'=>$session->id])}}" class="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Attempt">
																<!--begin::Svg Icon | path: icons/duotune/general/gen055.svg-->
																<span class="svg-icon svg-icon-2 m-0">
																	<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
																		<path opacity="0.3" fill-rule="evenodd" clip-rule="evenodd" d="M2 4.63158C2 3.1782 3.1782 2 4.63158 2H13.47C14.0155 2 14.278 2.66919 13.8778 3.04006L12.4556 4.35821C11.9009 4.87228 11.1726 5.15789 10.4163 5.15789H7.1579C6.05333 5.15789 5.15789 6.05333 5.15789 7.1579V16.8421C5.15789 17.9467 6.05333 18.8421 7.1579 18.8421H16.8421C17.9467 18.8421 18.8421 17.9467 18.8421 16.8421V13.7518C18.8421 12.927 19.1817 12.1387 19.7809 11.572L20.9878 10.4308C21.3703 10.0691 22 10.3403 22 10.8668V19.3684C22 20.8218 20.8218 22 19.3684 22H4.63158C3.1782 22 2 20.8218 2 19.3684V4.63158Z" fill="currentColor" />
