	...
	<body data-kt-name="metronic" id="kt_body">
											...
											<div data-kt-inbox-message="message_wrapper">
												...
												<div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer" data-kt-inbox-message="header">
													...
													<div class="d-flex align-items-center">
														...
														<div class="pe-5">
															...
															<div class="d-flex align-items-center flex-wrap gap-1">
																<h1 href="#" class="fw-bold text-dark text-hover-primary">Exam {{$exam}} : {{$section->title}}</h1>
													...
													<div class="d-flex align-items-center flex-wrap gap-2">
														<!--begin::Date-->
														<h3 class="fw-semibold time text-muted text-end me-3">{{$duration}}</h3>
														<!--end::Date-->
														<div class="d-flex">
															<!--begin::Reply-->
												...
												<form method="POST" id="Exam" enctype="multipart/form-data" action="{{ route('store-attempt',['exam'=>1,'id'=>$section->id,'attemptid'=>$attempt->id]) }}" class="form w-100" novalidate="novalidate" >
                            					@csrf
												@foreach($questions as $question)
												<div class="collapse fade show" data-kt-inbox-message="message">
													<div class="py-5">
                                                    <h5>Q{{++$sno}}. {{$question->question}}</h5>
													<input id="question" value="{{$question->question}}" class="form-control bg-transparent" type="hidden" name="question[]" />
													<textarea id="answer" placeholder="Answer" name="answer[]" class="form-control bg-transparent" rows="6" type="text" required autofocus ></textarea>
													</div>
												</div>
												@endforeach
												<div class="row mb-10" style="float:right;">
													<button type="button" style="width:100px;margin-right:5px;" class="btn btn-primary pause" onclick="pause()">
														<!--begin::Indicator label-->
														<span class="indicator-label">Pause</span>
														<!--end::Indicator label-->
														
													</button>
													<button type="button" style="width:100px;margin-right:5px;" class="btn btn-primary play" onclick="play()">
														<!--begin::Indicator label-->
														<span class="indicator-label">Resume</span>
														<!--end::Indicator label-->
														
													</button>
													<button type="submit" style="width:100px;" id="" class="btn btn-primary submit">
														<!--begin::Indicator label-->
		...
		$(document).ready(function(){
			...
			var timer = setInterval(()=>{
				...
				let lMinutes = minutes.toString().length > 1 ? minutes:'0'+minutes;
				let lSeconds = seconds.toString().length > 1 ? seconds:'0'+seconds;
				$('.time').text(lMinutes+':'+lSeconds+' Time Left');
