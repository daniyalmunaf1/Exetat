				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div id="kt_header" class="header">
						...
						<div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">Edit Session</h1>
								<hr>
								<!--end::Heading-->
							</div>
							<!--end::Page title=-->
					...
					<div class="d-flex flex-center flex-column flex-lg-row-fluid">
						...
						<div class="w-lg-500px p-10">
							<!--begin::Form-->
							<form method="POST" enctype="multipart/form-data" action="{{ route('update-session',$session) }}" class="form w-100" novalidate="novalidate" id="" >
                            @csrf
								<!--begin::Heading-->
								...
								<select class="form-control bg-transparent" name="section" id="section">
								<option value="{{$session->sectionid}}">{{$sectiontitle}}</option>
                                ...
                                <div class="fv-row mb-8">
									<!--begin::title-->
                                    <input id="numberOfQuestions" min="1" placeholder="Number Of Questions" value="{{ $session->numberOfQuestions }}" class="form-control bg-transparent" type="number" name="numberOfQuestions" required autofocus />
									<!--end::title-->
								</div>
								<div class="fv-row mb-8">
									<!--begin::title-->
                                    <input id="duration"  placeholder="Duration in Minutess" value="{{ $session->duration }}" class="form-control bg-transparent" type="number" min="1" name="duration" required autofocus />
									<!--end::title-->
								</div>
