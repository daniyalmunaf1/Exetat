							...
							<div class="card mb-5 mb-xl-10">
								...
								<div class="card-header border-0 pt-5">
									<h3 class="card-title align-items-start flex-column">
										<span class="card-label fw-bold fs-3 mb-1">Session Attempts</span>
									</h3>
										...
										<table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
											...
											<thead>
												<tr class="fw-bold text-muted">
													...
													<th class="min-w-50px">Session</th>
													<th class="min-w-100px">Exam</th>
													...
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-45px me-5">
																<img src="{{asset('/storage/'.$attempt->profilepic)}}" alt="">
															</div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-dark fw-bold text-hover-primary fs-6">{{$attempt->name}}</a>
																<span class="text-muted fw-semibold text-muted d-block fs-7">{{$attempt->email}}</span>
															</div>
														</div>
													</td>
													<td>
														<a class="text-dark fw-bold text-hover-primary 	d-block fs-6">{{$attempt->session}}</a>
													</td>
													<td>
														<a class="text-dark fw-bold text-hover-primary 	d-block fs-6">{{$attempt->exam}}</a>
													</td>
													<td>
														<a class="text-dark fw-bold text-hover-primary 	d-block fs-6">{{$attempt->score}}</a>
													</td>
													<td>
														<a class="text-dark fw-bold text-hover-primary 	d-block fs-6">{{$attempt->status}}</a>
													</td>
													<td>
														<a class="text-dark fw-bold text-hover-primary d-block fs-6">{{$attempt->created_at}}</a>
													</td>
													
													<td>
														<div class="d-flex justify-content-end flex-shrink-0">
															<a href="{{route('view-attempt',$attempt->a_id)}}" class="btn btn-light btn-bg-light btn-sm me-1">Check</a>
