							...
							<div class="card mb-5 mb-xl-10">
								...
								<div class="card-header border-0 pt-5">
									<h3 class="card-title align-items-start flex-column">
										<span class="card-label fw-bold fs-3 mb-1">Reviews Approval</span>
									</h3>
													...
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-45px me-5">
																<img src="{{asset('/storage/'.$review->profilepic)}}" alt="">
															</div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-dark fw-bold text-hover-primary fs-6">{{$review->name}}</a>
																<span class="text-muted fw-semibold text-muted d-block fs-7">{{$review->email}}</span>
															</div>
														</div>
													</td>
													<td>
														<a class="text-dark fw-bold text-hover-primary d-block fs-6">{{$review->content}}</a>
													</td>
													<td>
														<a class="text-dark fw-bold text-hover-primary d-block fs-6">{{$review->created_at}}</a>
													</td>
													
													<td>
														<div class="d-flex justify-content-end flex-shrink-0">
															<a href="{{route('review',$review->p_id)}}" class="btn btn-light btn-bg-light btn-sm me-1">View</a>
															
															
															
															<a href="{{route('delete-reviews',$review->p_id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
															...
															<a href="{{route('approve-reviews',$review->p_id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
