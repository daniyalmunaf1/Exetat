									...
									<div class="card">
										...
										<div class="card-body">
											...
											<div data-kt-inbox-message="message_wrapper">
												...
												<form method="POST" enctype="multipart/form-data" action="{{ route('store-attempt-status',$id) }}" class="form w-100" novalidate="novalidate" id="" >
                            						@csrf
													<div class="row mb-8">
													<!--begin::title-->
													<div class="col-4">
													<input placeholder="Score" value="{{ $attempt->score}}" class="form-control bg-transparent" type="text" name="score" required autofocus />
													</div>
													<div class="col-4">
													<input placeholder="Status" value="{{ $attempt->status}}" class="form-control bg-transparent" type="text" name="status" required autofocus />
													</div>
													<div class="col-4">
