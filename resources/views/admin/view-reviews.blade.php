											...
											<div data-kt-inbox-message="message_wrapper">
												...
												<div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer" data-kt-inbox-message="header">
													...
													<div class="d-flex align-items-center">
														...
														<div class="pe-5">
															...
															<div class="d-flex align-items-center flex-wrap gap-1">
																<h1 href="#" class="fw-bold text-dark text-hover-primary">Review By {{$review->name}}</h1>
													...
													<div class="d-flex align-items-center flex-wrap gap-2">
														<!--begin::Date-->
														<span class="fw-semibold text-muted text-end me-3">{{$review->created_at}}</span>
														<!--end::Date-->
														<div class="d-flex">
															
															<!--end::Reply-->
															<!--begin::Settings-->
															<a href="{{route('delete-reviews',$review->id)}}" class="btn btn-sm btn-icon btn-clear btn-active-light-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete">
															...
															<a href="{{route('approve-reviews',$review->id)}}" class="btn btn-sm btn-icon btn-clear btn-active-light-primary">
