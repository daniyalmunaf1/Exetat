		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                    ...
                    <div class="text-center alert alert-danger">{{ Session::get('issue') }}</div>
                    </div>
							...
							<div class="card mb-5 mb-xl-10">
								...
								<div class="card-header border-0 pt-5">
									<h3 class="card-title align-items-start flex-column">
										<span class="card-label fw-bold fs-3 mb-1">Questions Approval</span>
									</h3>
									<div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a user">
										<a href="{{route('new-question')}}" class="btn btn-sm btn-light btn-active-primary" >
										...
										<table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
											...
											<thead>
												<tr class="fw-bold text-muted">
													...
													<th class="min-w-50px">Enabled</th>
													<th class="min-w-200px">Submitter</th>
													<th class="min-w-50px">Q#Id</th>
													<th class="min-w-100px">Cousre</th>
											...
											<tbody>
												<tr>
													<td>
														<a class="text-dark fw-bold text-hover-primary d-block fs-6">{{++$sno}}</a>
													</td>
													<td>
													<form method="POST" action="{{route('question-enabled')}}" class="" novalidate="novalidate" id="" >
																@csrf
																<button type="submit" class="btn btn-icon btn-active-color-primary btn-sm me-1">
																	<label class="form-check form-switch form-check-custom form-check-solid">
																	<input type="hidden" name="id" value="{{$question->p_id}}">
																		<input class="form-check-input w-30px h-20px" type="checkbox" name="lock" @if($question->enabled==1) checked @endif disabled readonly/>
																	</label>
																	<!--end::Svg Icon-->
																</button>
															</form>
													...
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-45px me-5">
																<img src="{{asset('/storage/'.$question->profilepic)}}" alt="">
															</div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-dark fw-bold text-hover-primary fs-6">{{$question->name}}</a>
																<span class="text-muted fw-semibold text-muted d-block fs-7">{{$question->email}}</span>
															</div>
														</div>
													</td>
													<td>
														<a class="text-dark fw-bold text-hover-primary 	d-block fs-6">{{$question->p_id}}</a>
													</td>
													<td>
														<a class="text-dark fw-bold text-hover-primary 	d-block fs-6">{{$question->option}}</a>
													</td>
													<td>
														<a class="text-dark fw-bold text-hover-primary d-block fs-6">{{$question->created_at}}</a>
													</td>
													
													<td>
														<div class="d-flex justify-content-end flex-shrink-0">
															<a href="{{route('question',$question->p_id)}}" class="btn btn-light btn-bg-light btn-sm me-1">View</a>
															
															<a href="{{route('edit-question',$question->p_id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
																<!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
																<span title="Edit" class="svg-icon svg-icon-3">
																	<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
															...
															<a href="{{route('delete-question',$question->p_id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
																<!--begin::Svg Icon | path: icons/duotune/general/gen027.svg-->
																<span  title="Delete" class="svg-icon svg-icon-3">
																	<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
															...
															<a href="{{route('approve-question',$question->p_id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
																<!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
																<span title="Approve" class="svg-icon svg-icon-2 ">
																	<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
															...
															<a href="{{route('assign-question',$question->p_id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">

															<span title="Assign To Course" class="svg-icon svg-icon-2">
																<svg width="24"  height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
