				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="d-flex flex-center flex-column flex-lg-row-fluid">
						...
						<div class="w-lg-500px p-10">
							<!--begin::Form-->
							<form method="POST" enctype="multipart/form-data" action="{{ route('store-package') }}" class="form w-100" novalidate="novalidate" id="" >
                            @csrf
								<!--begin::Heading-->
                                ...
                                <div class="fv-row mb-8">
									<!--begin::title-->
                                    <input id="title" placeholder="Title" value="{{ old('title') }}" class="form-control bg-transparent" type="text" name="title" required autofocus />
									<!--end::title-->
								</div>
								<div class="fv-row mb-8">
									<!--begin::title-->
                                    <input id="amount" placeholder="Amount" value="{{ old('amount') }}" class="form-control bg-transparent" type="text" name="amount" required autofocus />
									<!--end::title-->
								</div>
								<div class="fv-row mb-8">
									<!--begin::content-->
                                    <textarea id="content" placeholder="Content" value="{{ old('content') }}" class="form-control bg-transparent" rows="6" type="text" name="content" required autofocus ></textarea>
									<!--end::content-->
								</div>
