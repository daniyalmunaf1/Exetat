							...
							<div class="card mb-5 mb-xl-10">
								...
								<div class="card-header border-0 pt-5">
									<h3 class="card-title align-items-start flex-column">
										<span class="card-label fw-bold fs-3 mb-1">Publications Approval</span>
									</h3>
									<div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a user">
										<a href="{{route('new-publication')}}" class="btn btn-sm btn-light btn-active-primary" >
										...
										<!--end::Svg Icon-->New Publication</a>
									</div>
								</div>
								<!--end::Header-->
								<!--begin::Body-->
													...
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-45px me-5">
																<img src="{{asset('/storage/'.$publication->profilepic)}}" alt="">
															</div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-dark fw-bold text-hover-primary fs-6">{{$publication->name}}</a>
																<span class="text-muted fw-semibold text-muted d-block fs-7">{{$publication->email}}</span>
															</div>
														</div>
													</td>
													<td>
														<a class="text-dark fw-bold text-hover-primary d-block fs-6">{{$publication->title}}</a>
													</td>
													<td>
														<a class="text-dark fw-bold text-hover-primary d-block fs-6">{{$publication->created_at}}</a>
													</td>
													
													<td>
														<div class="d-flex justify-content-end flex-shrink-0">
															<a href="{{route('publication',$publication->p_id)}}" class="btn btn-light btn-bg-light btn-sm me-1">View</a>
															
															<a href="{{route('edit-publication',$publication->p_id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
															...
															<a href="{{route('delete-publication',$publication->p_id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
															...
															<a href="{{route('approve-publication',$publication->p_id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
																<!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
