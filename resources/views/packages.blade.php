									...
									<div class="card card-flush mb-0" data-kt-sticky="false" data-kt-sticky-name="inbox-aside-sticky" data-kt-sticky-offset="{default: false, xl: '0px'}" data-kt-sticky-width="{lg: '275px'}" data-kt-sticky-left="auto" data-kt-sticky-top="150px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
										...
										<div class="card-body">
											...
											<div class="menu menu-column menu-rounded menu-state-bg menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary mb-10">
                                                ...
                                                <a href="{{route('view-package',$package->id)}}">
												<div class="menu-item mb-3">
													...
													<span class="menu-link">
														...
														<span class="menu-title fw-bold">{{$package->title}}</span>
													</span>
													<!--end::Draft-->
												</div>
                                                @endforeach
										...
										<div class="card-body">
											...
											<div data-kt-inbox-message="message_wrapper">
												...
												<div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer" data-kt-inbox-message="header">
													...
													<div class="d-flex align-items-center flex-wrap gap-2">
														...
														<div class="d-flex">
															@can('admin-helpdesk')
															<!--begin::Reply-->
															<a href="{{route('edit-package',$first->id)}}" class="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
															...
															<!--begin::Settings-->
															@can('admin')
															<a href="{{route('delete-package',$first->id)}}" class="btn btn-sm btn-icon btn-clear btn-active-light-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Settings">
												...
												<div class="collapse fade show" data-kt-inbox-message="message">
													<div class="py-5">
													<h3 href="#" class="fw-bold text-dark text-hover-primary mb-5">Amount : {{$first->amount}}$</h3>
